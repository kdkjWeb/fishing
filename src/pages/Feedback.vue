                ...
                <el-col :span="14">
                    <el-form :inline="true" :model="formInline" class="demo-form-inline" size="mini">
                        <el-form-item label="阅读：">
                            <el-select clearable v-model="formInline.status" placeholder="是否阅读">
                            <el-option label="已" value="1"></el-option>
                            <el-option label="未" value="0"></el-option>
                            </el-select>
                        </el-form-item>
                        <el-form-item label="反馈人：">
                            <el-input clearable v-model="formInline.nickname" placeholder="反馈人"></el-input>
                        </el-form-item>
                        <el-form-item label="意见反馈：">
                            <el-input clearable v-model="formInline.content" placeholder="意见反馈"></el-input>
                        </el-form-item>
...
export default {
    data(){
        return {
            ...
            tableList: [   //表格的头部配置
                ...
                {prop: 'cdate', label: '反馈时间', width: '160', align: 'right'},
                {prop: '', label: '', width: '20', align: ''}
            ],
            tableData: [],//表格的数据
    ...
    methods: {
        ...
        getAllFavoriteList(pageSize,pageNum){
            this.$post('common/getSuggestions',{
                ...
                if(res.code == 0){
                        if(res.data.list!=undefined){
                            ...
                            arr.forEach((e,index)=>{
                                arr[index].status = e.status == 0 ? '未' : '已'
                            })
