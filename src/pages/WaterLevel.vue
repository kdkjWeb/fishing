...
export default {
    data(){
        return {
            ...
            tableList: [   //表格的头部配置
                ...
                {prop: 'type', label: '水库类型', width: '80', align: ''},
                {prop: 'fishPlaceName', label: '钓场', width: '120', align: ''},
                {prop: 'cdate', label: '采集时间', width: '100', align: 'right'},
    ...
    methods: {
        ...
        getAllCoinList(pageSize,pageNum){
            this.$post('weather/queryStationByRecordWeb',{
        ...
        exportd(){
            ...
            let href = path + 'weather/downloadStation'
            let json = {};
            ...
            Object.keys(this.formInline).forEach((key,index)=>{
                if(this.formInline[key] != '' && key != 'date'){
                    ...
                    json.cdate2 =  `${this.dataTransform(this.formInline.date[1])} 23:59:59`;
                }
            })
