...
export default {
    data(){
        return {
            ...
            tableList: [   //表格的头部配置
                ...
                {prop: 'way', label: '加分方式', width: '100', align: ''},
                {prop: 'score', label: '加分多少', width: '80', align: 'right'},
                {prop: 'cdate', label: '生成时间', width: '160', align: 'right'},
    ...
    methods: {
        ...
        getAllCoinList(pageSize,pageNum){
            this.$post('scorecoin/getScoreList',{
        ...
        exportd(){
            ...
            let href = path + 'scorecoin/downloadScoreList'
            let json = {};
