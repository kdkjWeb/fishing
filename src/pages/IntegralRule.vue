...
export default {
    data(){
        return {
            ...
            tableList: [   //表格的头部配置
                {prop: 'name', label: '名称', width: '100', align: ''},
                {prop: 'way', label: '方式', width: '100', align: ''},
                {prop: 'score', label: '增加积分', width: '80', align: 'right'},
                {prop: 'coin', label: '增加金币', width: '80', align: 'right'},
                {prop: 'cUser', label: '创建人', width: '80', align: 'right'},
    ...
    methods: {
        ...
        getAllCoinList(pageSize,pageNum){
            this.$post('scoreRule/queryLevelList',{
